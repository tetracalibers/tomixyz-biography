...
幸いなのは、強い脳疲労を抱える中でも、限られた脳のリソースをどう生かすか、この状況でもできることを増やすための工夫に、頭を巡らせる余力があったことです。（私の場合、思考がまとまらないがゆえにインプットやアウトプットには支障がありましたが、雑多に思考することはできました。）
...
ここで語る過程には、「何も考えずにとりあえず休みなさい」というツッコミが入るかもしれません。先の見えない状態で、休む忍耐力を持ち合わせていないのは、私の一つの弱点だと自覚はしています。
...
これは当時の私にとっては、脳に一度にかかる負荷を軽減して、なんとか必要最低限の作業をこなすためにやらざるを得なかったことです。しかし、解決すべき問題を分割し、「何に対して」「どう対応するか」をしっかり決めてから実際の作業に入ることは、エンジニアとしての普段の業務でも習慣にすべきことだと思います。
...
さて、症状が出る直前も、相変わらず個人開発としていろいろやってはいましたが、それを見える形にはできていない状態が続いていました。成果としてアウトプットしていても、言葉としてのアウトプットはしていなかったのです。
...
症状から回復するまでのこの数ヶ月間、技術的なスキルはあまり伸ばせていないでしょう。しかし、休む技術は少し身につけられた気がしています。
...
自分の中から、「無理をする」という選択を完全に排除したとき、何が残るのか。当たり前のこともできない状況で、無理のない活動範囲に限ったとき、自分に何ができるのか。
