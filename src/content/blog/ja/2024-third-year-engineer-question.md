...
この章で取り上げるその過程には、「何も考えずにとりあえず休みなさい」というツッコミが何度も入るかもしれません。先の見えない状態で、休む忍耐力を持ち合わせていないのは、私の一つの弱点だと自覚はしています。
...
かといって、考えたことを文章に書き出そうとすると余計に疲弊し、逆効果になるという状態が続いていました。
...
また、マインドマップ（Xmind）では、情報の関連に気づいたら、矢印や要約囲みを使って、すぐに視覚化することが可能です。「これは何と関連するんだっけ…？」などといった、関係性を思い出す作業も避けることができます。
...
ここで仇となったのが、複合的なタスクであっても、取り組む過程を人に見せることを好まない、「完璧主義」な性格でした。
...
個人開発で行き詰まったとき、そもそも何のためにやっているのか、意味が欲しくなることも正直あります。個人開発では、すぐに仕事で使う技術に絞らず、さまざまな分野に触れようとしているので、尚更…
...
見えるものを追求した結果、見えないものをおざなりにしてきたのではないかと感じています。そして、空の箱から取り出せるものが何もないように、あえて人には見せない材料がなければ、人に見える形を生み出すことも難しいのです。

#### 交わるための広さを持つ

「仲間が欲しい」というのは、長年抱いている切なる夢です。今、周りにいる人はまだ仲間ではない、と言いたいのではなく、その人たちと「議論できるようになりたい」という意味です。
