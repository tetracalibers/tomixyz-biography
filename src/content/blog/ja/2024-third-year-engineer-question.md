...
ここで必要となったのが、話題を分割してから、各話題に取り組むこと。作業してから報告するのではなく、報告する粒度や報告のあらすじを決めてから作業に入るという、並行作業を直列的に繋ぎ直すための分解と順序づけです。
解決すべき問題を分割し、それぞれ「何に対して」「どう対応するか」をしっかり決めてから、実際の作業に入ることが必須になりました。

仇となったのは、複合的なタスクであっても、取り組む過程を人に見せることに抵抗を抱きがちな、「完璧主義」な性格でした。
普段のペースであれば、作業を完結させてから公開することも許容範囲でしたが、作業ペースが落ちている以上、過程を見せなければ、進捗がまったく伝わらない状況に陥ってしまうのです。

整理する過程も見せることで、行き詰まっているところを客観視できます。また、他の人にも開示することができます。
