...
<RawCodeBlock lang="言語名" options="showLineNumbers {2}" title="md/MDXのコードブロックの記法">
  コード
</RawCodeBlock>
...
<RawCodeBlock lang="言語名" options="showLineNumbers {2-4}" title="md/MDXのコードブロックの記法">
  コード
</RawCodeBlock>
...
<RawCodeBlock lang="言語名" options="showLineNumbers {2-4,6}" title="md/MDXのコードブロックの記法">
  コード
</RawCodeBlock>
